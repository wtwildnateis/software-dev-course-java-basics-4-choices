...
public class CollectionExercises {
    public String[] makeFruitStringArray() {
        // Create an array of strings with the following values:
    ...
    public String[] makeFruitStringArrayWithSize(int size) {
        // Create an array of strings with the given size (from the parameter)
    ...
    public String[] makeTopThreeArray(String[] fruits) {
        // Create a new array of strings containing the first three elements of the given array
        // Replace the line below with your implementation
        return null;
    }

    public ArrayList<String> makeFruitList() {
        // Create an ArrayList of strings with the following values:
        // "apple", "banana", "cherry", "date", "elderberry"
        // Replace the line below with your implementation
        return null;
    }
    ...
    public ArrayList<String> makeListOfThreeFruits(String fruit1, String fruit2, String fruit3) {
        // Create an ArrayList of strings with the given values
        // Replace the line below with your implementation
        return null;
    }

    public HashMap<String, String> makeFruitMap() {
        // Create a HashMap with the following key-value pairs:
    ...
    public HashSet<String> makeFruitSet(String fruit1, String fruit2, String fruit3) {
        // Create a HashSet of strings with the given values
        // Replace the line below with your implementation
        return null;
    }
}
